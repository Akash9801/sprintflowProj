...
export default function Navbar({ onMenuToggle }) {
  ...
  return (
    // sticky within its flex-column parent — never overlaps the sidebar
    <header className="sticky top-0 z-10 h-14 bg-white border-b border-surface-100 flex items-center px-4 gap-4 flex-shrink-0">
      {/* Mobile hamburger */}
      <button
      ...
      {/* Page title */}
      <h1 className="page-title flex-1 text-base font-semibold text-surface-900">
