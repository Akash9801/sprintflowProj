...
export default function Footer() {
  return (
    <footer id="about" className="bg-surface-900 text-surface-400">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2.5 mb-4 group">
              ...
              <span className="text-lg font-bold text-white tracking-tight">SprintFlow</span>
            </Link>
            <p className="text-sm leading-relaxed mb-6 max-w-xs">
              A modern Kanban-powered task management platform built for teams that ship fast.
            </p>
          ...
          {Object.entries(links).map(([group, items]) => (
            <div key={group}>
              <div className="text-xs font-semibold text-surface-200 uppercase tracking-widest mb-4">{group}</div>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-surface-800">
